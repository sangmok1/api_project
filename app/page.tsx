    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center bg-white dark:bg-gray-800 rounded-2xl p-12 shadow-xl">
          ...
          <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">지금 시작해보세요!</h3>
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            구글 계정으로 간편하게 로그인하고 나만의 QR 코드를 생성해보세요. 무료로 이용할 수 있습니다.
          </p>
          <Button onClick={handleGetStarted} size="lg" className="text-lg px-8 py-4">
            구글로 시작하기
          </Button>
      ...
      <footer className="container mx-auto px-4 py-8 text-center text-gray-600 dark:text-gray-400">
        <p>&copy; 2024 QR Generator. Made with luckyviki</p>
      </footer>
    </div>
  )
}
